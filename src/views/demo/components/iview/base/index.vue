<template>
    <Tabs :animated="false">
        ...
        <TabPane label="按钮">
            ...
            <DemoCard :code="code.button[5]">
                <Button type="primary" loading>Loading...</Button>
            </DemoCard>

            <DemoCard :code="code.button[6]">
                <ButtonGroup>
        ...
        <TabPane label="Tag">
            ...
            <DemoCard :code="code.tag[0]">
                <Tag>标签一</Tag>
                <Tag>标签二</Tag>
                <Tag closable>标签三</Tag>
            </DemoCard>

            <DemoCard :code="code.tag[1]">
...
<script>
import DemoCard from '@/views/demo/components/_card.vue';

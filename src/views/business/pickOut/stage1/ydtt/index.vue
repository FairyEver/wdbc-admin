<template>
    <div>
        <LayoutHeader title="验蛋淘汰"></LayoutHeader>
        ...
        return {
            table: {
                columns: [
                    ...
                    {title: '世代', key: 'gen'},
                    {title: '批次', key: 'strain'},
                    {title: '入孵蛋数', key: 'eggset', control: 'InputNumber', style: { width: "50px"}},
                    {title: '受精蛋数', key: 'eggfert', control: 'InputNumber', style: { width: "50px"}}
                ],
                data: [],
                loading: false
            },

...
<template>
    <div class="main" :class="{'main-hide-text': hideMenuText}">
        <div class="sidebar-menu-con" :style="{width: hideMenuText?'0px':'200px', overflow: hideMenuText ? 'visible' : 'auto', background: $store.state.menuTheme === 'dark'?'#495060':'white'}">
            <div class="logo-con">
                <img v-show="!hideMenuText" :src="logoSrc" key="max-logo" />
        ...
        <div class="main-header-con" :style="{paddingLeft: hideMenuText?'0px':'200px'}">
        ...
        <div class="single-page-con" :style="{left: hideMenuText?'0px':'200px'}">
...
<script>
    ...
    import logoOnline from '../../images/logo.png'
    import logoQas from '../../images/logo-qas.png'
    import logoTest from '../../images/logo-test.png'
    import logoDev from '../../images/logo-dev.png'
    import logoLocal from '../../images/logo-local.png'
    ...
    export default {
        ...
        created () {
            ...
            // 恢复侧边栏列表数据
            this.$store.commit('reloadNavList');
            // 恢复权限数据
            this.$store.commit('reloadPermissionList');
        }
    };
</script>
